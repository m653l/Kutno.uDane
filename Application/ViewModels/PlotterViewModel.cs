...
namespace Application.ViewModels
{
    public partial class PlotterViewModel : CoreViewModel
    {
        ...
        [ObservableProperty]
        public List<ISeries> saldosSeries;
        [ObservableProperty]
        public List<ISeries> saldosPerStudentSeries;
        [ObservableProperty]
        public List<ISeries> stalinSeries;
        [ObservableProperty]
        public List<ISeries> costPerStalinSeries;
        ...
        public void UpdateCharts()
        {
            ...
            for (int i = 0; i < _applicationDataStore.ActiveYear.Schools.Count; i++)
            {
                saldos.Add(new PilotInfo(_applicationDataStore.ActiveYear.Schools[i].Name, (double)_applicationDataStore.ActiveYear.Schools[i].GetSaldo(), _paints[i]));
                saldosPerStudent.Add(new PilotInfo(_applicationDataStore.ActiveYear.Schools[i].Name, (double)_applicationDataStore.ActiveYear.Schools[i].GetSaldoPerStudent(), _paints[i]));
                stalin.Add(new PilotInfo(_applicationDataStore.ActiveYear.Schools[i].Name, (double)_applicationDataStore.ActiveYear.Schools[i].GetTrzyStaliny(), _paints[i]));
                costPerStalin.Add(new PilotInfo(_applicationDataStore.ActiveYear.Schools[i].Name, (double)_applicationDataStore.ActiveYear.Schools[i].GetCostPerStanin(), _paints[i]));
            }
